package com.github.zf.base.httpclient.builder;

import com.github.zf.base.exception.HttpProcessException;
import com.github.zf.base.httpclient.utils.HttpSsl;
 ...
 * @date 2017/11/28
 */
public class HttpBuilder extends HttpAsyncClientBuilder {
    ...
    public HttpBuilder timeout(int timeout) {
        ...
        return (HttpBuilder) this.setDefaultRequestConfig(config);
    }
     ...
     */
    public HttpBuilder ssl() throws HttpProcessException {
        ...
        // supported
        // protocol schemes.
        Registry<SchemeIOSessionStrategy> sessionStrategyRegistry = RegistryBuilder.<SchemeIOSessionStrategy> create().register("http", NoopIOSessionStrategy.INSTANCE).register("https", ssls.getSSLIOSS()).build();
        // 配置io线程
     ...
     * @throws HttpProcessException
     */
    public HttpBuilder ssl(String keyStorePath, String keyStorepass) throws HttpProcessException {
     ...
     * @throws HttpProcessException
     */
    public HttpBuilder pool(int maxTotal, int defaultMaxPerRoute) throws HttpProcessException {
        if (isSetPool) {// 如果已经设置过线程池，那肯定也就是https链接了
            return this;
        }
        // Create a registry of custom connection session strategies for
